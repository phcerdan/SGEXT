...
class TestEdgePointsUtilities(unittest.TestCase):
    def test_edge_points_length(self):
        ...
        se.edge_points = [core.array.array3d(0,0,0), core.array.array3d(1,0,0)]
    ...
    def test_insert_unique_edge_point_with_distance_order(self):
        point0 = core.array.array3d(0,0,0)
        point1 = core.array.array3d(1,0,0)
        point2 = core.array.array3d(2,0,0)
        new_point = core.array.array3d(3,0,0)
