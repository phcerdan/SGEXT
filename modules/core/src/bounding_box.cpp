...
BoundingBox::BoundingBox(const PointType &center,
                         const std::array<size_t, 3> &radius, const bool) {
...
BoundingBox::BoundingBox(double xMin, double xMax, double yMin, double yMax,
                         double zMin, double zMax) {
  this->SetBounds(xMin, xMax, yMin, yMax, zMin, zMax);
};

void BoundingBox::SetBounds(double xMin, double xMax, double yMin, double yMax,
                            double zMin, double zMax) {
  ini = {{xMin, yMin, zMin}};
  end = {{xMax, yMax, zMax}};
}
