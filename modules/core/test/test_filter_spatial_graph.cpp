...
TEST_F(FilterComponentsFixture, works) {
  ...
  for(auto vi = first_verts.first; vi != first_verts.second; vi++, first_component_vertices++){}
  ...
  for(auto ei = first_edges.first; ei != first_edges.second; ei++, first_component_edges++){}
  ...
  for(auto vi = second_verts.first; vi != second_verts.second; vi++, second_component_vertices++){}
  ...
  for(auto ei = second_edges.first; ei != second_edges.second; ei++, second_component_edges++){}
