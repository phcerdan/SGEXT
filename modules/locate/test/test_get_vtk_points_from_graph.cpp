...
TEST_F(GetVtkPointsFromGraphFixture, get_vtk_points_from_graphs_with_two_equal_graphs)
{
    const auto & g0 = g;
    const auto g1 = g;
...
TEST_F(GetVtkPointsFromGraphFixture, get_vtk_points_from_graphs_with_two_different_graphs)
{
    const auto & g0 = g;
    auto g1 = g;
    SG::SpatialNode sn;
