...
int main(int argc, char* const argv[]){
  ...
  general_opt.add_options()
    ...
    ( "inputDistanceMap,i", po::value<string>()->required(), "Input distance map, generated by script." )
    ( "inputThinImage,m", po::value<string>()->required(), "Input thin image, this is used as a mask." )
