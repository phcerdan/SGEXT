...
ENV VTK_BUILD_FOLDER_NAME VTK-build
ENV VTK_BUILD_DIR ${BUILD_PATH}/${VTK_BUILD_FOLDER_NAME}
...
ENV ITK_BUILD_FOLDER_NAME ITK-build
ENV ITK_BUILD_DIR ${BUILD_PATH}/${ITK_BUILD_FOLDER_NAME}
...
ENV DGtal_BUILD_FOLDER_NAME DGtal-build
ENV DGtal_BUILD_DIR ${BUILD_PATH}/${DGtal_BUILD_FOLDER_NAME}
...
ENV SGEXT_SCRIPTS_GIT_TAG 7f5bd3a63b2ad4e2ba7d5f9120cb1d65e728f0d0
ENV SGEXT_SCRIPTS_BUILD_FOLDER_NAME SGEXT_SCRIPTS-build
ENV SGEXT_SCRIPTS_BUILD_DIR ${BUILD_PATH}/${SGEXT_SCRIPTS_BUILD_FOLDER_NAME}
