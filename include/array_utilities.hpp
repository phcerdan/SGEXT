 ...
 *
 * From cpp std:
 * If no errors occur, the arc tangent of y/x (atan( y, x)) in the range [-pi ; +pi] radians, is returned.
 * @return angle
 */
 ...
 * @return array + scalar
 */
inline Array3D plus_scalar(const Array3D & lhs, const Array3D::value_type& scalar )
{
 ...
 * @return array - scalar
 */
inline Array3D minus_scalar(const Array3D & lhs, const Array3D::value_type& scalar )
{
...
inline Array3D::value_type cos_director(const Array3D& lhs, const Array3D& rhs)
{
